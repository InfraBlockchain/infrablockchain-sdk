...
use crate::{common::Limits, util::CheckedDivCeil};
...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        /// Remove the on-chain DID along with its keys, controllers, service endpoints and BBS+
        /// keys. Other DID-controlled entities won't be removed.
