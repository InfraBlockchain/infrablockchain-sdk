...
pub mod pallet {
    ...
    pub enum Error<T> {
        ...
        /// a priority of 0. To override this initial value, a priority of 1 or greater is
        /// required. Check to see that the provided priority is not zero as that could be the
        /// cause of this error.
        PriorityTooLow,
    }
