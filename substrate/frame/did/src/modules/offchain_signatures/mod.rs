...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        /// Add new offchain signature public key. Only the DID controller can add key and it should
        /// use the nonce from the DID module. This kind of key cannot be removed by calling
        ...
        /// Remove existing offchain signature public key. Only the DID controller can remove key
