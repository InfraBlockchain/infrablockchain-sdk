...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn add_params_sr25519(b: u32, l: u32) -> Weight {
        Weight::from_all(52_181_000_u64)
            // Standard Error: 0
            .saturating_add(Weight::from_all(7_000_u64).saturating_mul(b as u64))
            // Standard Error: 0
            .saturating_add(Weight::from_all(9_000_u64).saturating_mul(l as u64))
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(3_u64))
    }
    fn add_params_ed25519(b: u32, l: u32) -> Weight {
        Weight::from_all(52_658_000_u64)
            // Standard Error: 0
            .saturating_add(Weight::from_all(3_000_u64).saturating_mul(b as u64))
            // Standard Error: 0
            .saturating_add(Weight::from_all(3_000_u64).saturating_mul(l as u64))
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(3_u64))
    }
    fn add_params_secp256k1(b: u32, l: u32) -> Weight {
        Weight::from_all(154_268_000_u64)
            // Standard Error: 0
            .saturating_add(Weight::from_all(1_000_u64).saturating_mul(b as u64))
    ...
    fn remove_params_sr25519() -> Weight {
        Weight::from_all(56_041_000_u64)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn remove_params_ed25519() -> Weight {
        Weight::from_all(52_544_000_u64)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn remove_params_secp256k1() -> Weight {
        Weight::from_all(155_224_000_u64)
            .saturating_add(T::DbWeight::get().reads(3_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn add_public_sr25519(b: u32) -> Weight {
        Weight::from_all(59_312_000_u64)
            // Standard Error: 0
            .saturating_add(Weight::from_all(12_000_u64).saturating_mul(b as u64))
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn add_public_ed25519(b: u32) -> Weight {
        Weight::from_all(58_693_000_u64)
            // Standard Error: 0
            .saturating_add(Weight::from_all(3_000_u64).saturating_mul(b as u64))
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    ...
    fn add_public_secp256k1(_b: u32) -> Weight {
        Weight::from_all(162_846_000_u64)
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn remove_public_sr25519() -> Weight {
        Weight::from_all(59_284_000_u64)
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn remove_public_ed25519() -> Weight {
        Weight::from_all(57_625_000_u64)
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    fn remove_public_secp256k1() -> Weight {
        Weight::from_all(161_804_000_u64)
            .saturating_add(T::DbWeight::get().reads(4_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
}
