...
use yosemite_runtime::Runtime as YosemiteRuntime;
...
impl Runtime {
	fn generate_thresholds_fn(
		...
		match self {
			Runtime::Yosemite => Box::new(generate_thresholds::<YosemiteRuntime>),
		}
	}
}
...
struct Opt {
	...
	#[arg(long, ignore_case = true, value_enum, default_value_t = Runtime::Yosemite)]
	runtime: Runtime,
